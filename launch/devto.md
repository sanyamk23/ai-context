...
## Title:
How I Cut My AI Coding Costs by 95% With One CLI Command
...
For me, that was ~7,000 tokens of waste — every single session. At Claude Sonnet 4 pricing, that's $0.02 per session just for the AI to "remember" what my project is. Multiply that by 20 sessions a day and a team of 5, and you're looking at $600/month in pure token waste.

I got tired of this, so I built **ai-context** — a CLI tool that analyzes your codebase once and generates a compact context document that the AI tool reads instead of re-scanning everything.
...
- **Dependency analysis** — reads pyproject.toml, package.json, Cargo.toml, go.mod
...
On my own project (ai-context itself):

| Metric | Value |
|---|---|
| Source tokens to read | 6,900 |
| Context file tokens | 295 |
| Reduction | 95.7% |
| Monthly savings (1 dev, 20 sessions) | ~$8 |
| Monthly savings (10 devs, 20 sessions) | ~$80 |
...
|---|---|---|---|
| Claude Opus 4 | $0.1036 | $0.0044 | 96% |
| Claude Sonnet 4 | $0.0207 | $0.0009 | 96% |
| GPT-4o | $0.0173 | $0.0007 | 96% |
| Gemini 2.5 Pro | $0.0086 | $0.0004 | 96% |
...
jobs:
  update:
    ...
    steps:
      ...
      - run: ai-context generate
      - run: ai-context generate --format cursor
...
cd your-project
ai-context generate
ai-context cost    # see your exact savings
```
